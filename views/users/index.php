    ...
    <div class="col-12 col-lg-9">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-3">
            <div>
                ...
                <p class="text-muted mb-0">Trova nuovi compagni di squadra, consulta i loro profili e invia richieste di amicizia.</p>
            </div>
        </div>
            ...
            <div class="card-body p-4">
                <form action="<?= url('/users') ?>" method="GET" id="search-form" class="no-spinner">
                    <div class="row g-3">
                        ...
                        <!-- Query Input -->
                        <div class="col-12">
                            <label for="search-input" class="form-label small fw-bold text-muted text-uppercase tracking-wider">Cerca per nome o username</label>
                            <div class="input-group search-input-group">
                                <span class="input-group-text bg-transparent border-0 pe-0 text-muted"><i class="bi bi-search"></i></span>
                                <input type="text" id="search-input" name="q" class="form-control search-control py-3" placeholder="Digita il nome o l'username di un giocatore..." value="<?= e($q ?? '') ?>">
                            </div>
                        </div>

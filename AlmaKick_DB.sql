...
('admin_test', 'match_cancellation', 'La partita a Campo Periferia del 28/06/2026 è stata annullata dall\'organizzatore (Motivo: Meteo avverso).', '/matches/6', 0, DATE_SUB(NOW(), INTERVAL 5 DAY)),
